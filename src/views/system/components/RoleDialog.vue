...
<template>
  <!-- 对话框 -->
  <el-dialog v-if="dialog.visible" ref="dialog" :title="dialogTitle" :visible.sync="dialog.visible" width="70%">
    <!-- 对话框内动态表单 -->
    <el-row>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form size="small" label-position="right" label-width="100px">
          <el-form-item label="菜单">
            <el-tree ref="tree" class="tree" :data="roleTreeData" :props="roleTreeMap" :node-key="roleTreeMap.nodeKey" auto-expand-parent show-checkbox highlight-current />
          </el-form-item>
        </el-form>
      </el-col>
    </el-row>
    ...
    <el-row type="flex" justify="end">
      <el-button type="primary" icon="el-icon-check" @click="btnSave_onClick()">保存</el-button>
      <el-button icon="el-icon-close" @click="btnCancel_onClick()">取消</el-button>
    </el-row>
  </el-dialog>
</template>
