    ...
    var option4 = {
        ...
        legend: {
            ...
            formatter: function (name) {
                console.log(name);
                var value = "";
                for (var k in FilingChartData) {
                    var obj = FilingChartData[k];
                    if (obj.name == name) {
                        value = obj.value;
                        break;
                    }
    ...
    option3 = {
        ...
        legend: {
            ...
            formatter: function (name) {
                console.log(name);
                var value = "";
                for (var k in PartyPunish) {
                    var obj = PartyPunish[k];
                    if (obj.name == name) {
                        value = obj.value;
                        break;
                    }
    ...
    var option4 = {
        ...
        legend: {
            ...
            formatter: function (name) {
                console.log(name);
                var value = "";
                for (var k in ClueSource) {
                    var obj = ClueSource[k];
                    if (obj.name == name) {
                        value = obj.value;
                        break;
                    }
...
//假数据
var Month = ['2018/01', '2018/02', '2018/03', '2018/04', '2018/05', '2018/06', '2018/07', '2018/08', '2018/09', '2018/10', '2018/11', '2018/12'];


var six = JSON.parse("[{ \"name\": \"违反廉洁纪律\", \"value\":\"104\"},{ \"name\": \"违反政治纪律\", \"value\":\"3\"},{ \"name\": \"违反生活纪律\", \"value\":\"7\"},{ \"name\": \"违反工作纪律\", \"value\":\"125\"},{ \"name\": \"违反组织纪律\", \"value\":\"24\"},{ \"name\": \"违反群众纪律\", \"value\":\"6\"}]");
var PartyPunish = JSON.parse("[{ \"name\": \"警告\", \"value\":\"297\"},{ \"name\": \"严重警告\", \"value\":\"155\"},{ \"name\": \"开除党籍\", \"value\":\"42\"}]");
var FilingChartData = JSON.parse("[{ \"name\": \"贪污贿赂\", \"value\":\"104\"},{ \"name\": \"滥用职权\", \"value\":\"3\"},{ \"name\": \"玩忽职守\", \"value\":\"7\"},{ \"name\": \"徇私舞弊\", \"value\":\"125\"},{ \"name\": \"重大责任事故\", \"value\":\"24\"},{ \"name\": \"行使公权力过程中发生的其他犯罪行为\", \"value\":\"6\"}]");
var ClueSource = JSON.parse("[{ \"name\": \"信访举报\", \"value\":\"104\"},{ \"name\": \"上级交办\", \"value\":\"3\"},{ \"name\": \"监督检查中发现\", \"value\":\"7\"},{ \"name\": \"审查调查中发现\", \"value\":\"125\"},{ \"name\": \"审计中发现\", \"value\":\"24\"},{ \"name\": \"巡视巡察中发现\", \"value\":\"6\"},{ \"name\": \"公检法机关移送\", \"value\":\"6\"},{ \"name\": \"其他行政执法机关移送\", \"value\":\"6\"},{ \"name\": \"其他\", \"value\":\"1\"}]");
var ClueData = RandomData(500,100);
var FilingData = RandomData(500, 100);
var mapData = [
