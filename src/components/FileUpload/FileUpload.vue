  ...
  <div class="upload-container">
    ...
    >
      <el-tooltip class="item" effect="dark" content="上传附件" placement="bottom">
        <el-button size="mini" v-show="view.uploadBtn" style="float: right" :icon="btnIcon" :loading="btnSaveIsLoading" type="primary">{{ btnText }}</el-button>
      </el-tooltip>
    </el-upload>
    <CrudTable
      ref="table"
...
export default class FileUpload extends Vue {
  ...
  get uploadParams() {
    const { resourceid, fileType } = this;
    let params: any = {
